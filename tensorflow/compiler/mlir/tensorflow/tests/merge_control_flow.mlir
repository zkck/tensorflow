...
// Check that two if regions groups with each of them contain 3 IfRegions with same predicate are merged
...
// Check that if regions groups with nested IfRegions with same predicate are merged in the same block level

// CHECK-LABEL: func @nested_IfRegions_with_same_predicatge_same_block_level_merged
func @nested_IfRegions_with_same_predicatge_same_block_level_merged() {
  // CHECK:      tf_device.cluster
  // CHECK:        "tf.IfRegion"
  // CHECK:        "tf.A"
  // CHECK:        "tf.IfRegion"
...
// CHECK-LABEL: func @two_overlapped_if_groups_with_dependency_no_merged_for_first_if_region_group
  // CHECK:      tf_device.cluster
  // CHECK:        "tf.IfRegion"
  // CHECK:          "tf.A"
  // CHECK:          "tf.B"
  ...
  // CHECK:          "tf.L"
  // CHECK-NOT:    "tf.IfRegion"
func @two_overlapped_if_groups_with_dependency_no_merged_for_first_if_region_group() {
  "tf_device.cluster"() ({
    %0 = "tf.Const"() {value = dense<true> : tensor<i1>} : () -> tensor<i1>
    %1 = "tf.Const"() {value = dense<false> : tensor<i1>} : () -> tensor<i1>
    %2 = "tf.IfRegion"(%0) ({
