...
func @cluster_ops_removed_attrs() {
  ...
  "tf.TPUReplicateMetadata"() {_replication_info = "replicate", device = "device", num_replicas = 1, topology = "topology"} : () -> ()
  return
}
...
func @removed_metadata_attrs() {
  ...
  "tf.TPUReplicateMetadata"() {_replication_info = "replicate", device = "device", name = "name", num_replicas = 1, topology = "topology"} : () -> ()
  return
}
...
func @interleaved_clusters(%arg0 : tensor<i1>) -> (tensor<i1>, tensor<i1>) {
  "tf.TPUReplicateMetadata"() {_replication_info = "replicate_1", device = "device_1", num_replicas = 1, topology = "topology_1"} : () -> ()
  ...
  "tf.TPUReplicateMetadata"() {_replication_info = "replicate_0", device = "device_0", num_replicas = 1, topology = "topology_0"} : () -> ()
...
func @replication(%arg0: tensor<i1>, %arg1: tensor<i32>, %arg2: tensor<f32>) -> (tensor<i32>, tensor<f32>) {
  ...
  "tf.TPUReplicateMetadata"() {_replication_info = "replicate", device = "device", num_replicas = 2, topology = "topology"} : () -> ()
...
func @replication_with_model_parallelism(%arg0: !rtype, %arg1: !rtype, %arg2: !rtype, %arg3: !rtype) -> (tensor<10x3xf32>, tensor<f32>) {
  ...
  "tf.TPUReplicateMetadata"() {_replication_info = "replicate", device = "device", num_cores_per_replica = 2 : i64, num_replicas = 2 : i64, topology = "topology"} : () -> ()
...
func @resource_after_cluster(%arg0: tensor<*x!tf_type.resource<tensor<f32>>>, %arg1: tensor<*x!tf_type.resource<tensor<f32>>>) {
  ...
  "tf.TPUReplicateMetadata"() {_replication_info = "cluster_test_fn", allow_soft_placement = false, computation_shape = [], device_assignment = [], host_compute_core = [], num_cores_per_replica = 1 : i64, num_replicas = 1 : i64, step_marker_location = "STEP_MARK_AT_ENTRY", topology = "", use_spmd_for_xla_partitioning = false, use_tpu = true} : () -> ()
...
func @cluster_nested_op_using_other_op() {
  ...
  "tf.TPUReplicateMetadata"() {_replication_info = "foo", device = "CPU", num_replicas = 1, topology = "topology"} : () -> ()
  return
}
...
func @multiple_replicated_interleaved(%arg0: !tf_res) {
  "tf.TPUReplicateMetadata"() {_replication_info = "a", num_replicas = 2, topology = "topology"} : () -> ()
  "tf.TPUReplicateMetadata"() {_replication_info = "b", num_replicas = 2, topology = "topology"} : () -> ()
  "tf.TPUReplicateMetadata"() {_replication_info = "c", num_replicas = 2, topology = "topology"} : () -> ()
...
func @missing_num_replicas() {
  ...
  "tf.TPUReplicateMetadata"() {_replication_info = "replicate", device = "device", topology = "topology"} : () -> ()
  return
}
...
func @bad_num_replicas() {
  ...
  %0 = "tf.opA"() {_xla_compile_device_type = "TPU", _replication_info = "replicate", device = "device", name = "name", is_stateless = true} : () -> tensor<i1>
  "tf.TPUReplicateMetadata"() {_replication_info = "replicate", device = "device", num_replicas = 0, topology = "topology"} : () -> ()
  return
}
...
func @replication_with_model_parallelism(%arg0: !rtype, %arg1: !rtype, %arg2: !rtype, %arg3: !rtype) -> (tensor<10x3xf32>) {
  ...
  %6 = "tf.opC"(%4) {_xla_compile_device_type = "TPU", _replication_info = "replicate", is_stateless = true} : (!rtype) -> tensor<10x3xf32>
  %7:2 = "tf.TPUReplicatedOutput"(%6) : (tensor<10x3xf32>) -> (tensor<10x3xf32>, tensor<10x3xf32>)
  "tf.TPUReplicateMetadata"() {_replication_info = "replicate", device = "device", num_cores_per_replica = 4 : i64, num_replicas = 2 : i64, topology = "topology"} : () -> ()
